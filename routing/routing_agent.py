...
class RoutingAgent:
    ...
    def __init__(self, registry_base_url: Optional[str] = None) -> None:
        self.registry = RegistryClient(
            registry_base_url or os.getenv("REGISTRY_BASE_URL", "http://localhost:18080")
        )
        # 可选：缓存已构造的直连连接（按逻辑名）
...
class RoutingAgent:
    def __init__(self):
        self._connections = {}
        self.registry = None  # 实际项目中这里通常是 registry 客户端实例
        ...
        resp = {
            ...
            "agents": [
                ...
                },
                {
                    ...
                    "agent_id": "a2",
                    "name": "Airbnb Agent",
                    "description": "Handles accommodation and booking queries",
